...
echo ""
echo "  Optional: .specify/templates/knowledge-seed.md holds portable engineering"
echo "  principles you can manually retain into your knowledge base (see README)."
echo ""
